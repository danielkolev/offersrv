...
import { Sidebar, SidebarContent, SidebarHeader, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarGroup, SidebarGroupContent, SidebarTrigger } from '@/components/ui/sidebar';
...
const OfferSidebar = ({
  ...
  return (
    <Sidebar variant={isMobile ? "floating" : "sidebar"} collapsible={isMobile ? "none" : "icon"}>
      <SidebarHeader>
        {user && (
          <div className="p-2">
            <CompanyManager 
