...
export const bgCompanyTranslations: CompanyTranslations = {
  ...
  updateCompany: 'Актуализирай фирма',
  ...
  noCompanies: 'Няма намерени фирми',
  ...
  manageCompanies: 'Управление на фирми',
  
  // Adding new properties
  create: 'Създай фирма',
  createButton: 'Създай фирма',
  updateButton: 'Актуализирай фирма',
  manage: 'Управление на фирми',
  info: 'Управлявайте информацията за вашата фирма',
  error: 'Грешка',
  success: 'Успех',
