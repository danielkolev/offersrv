...
const ProductsForm = () => {
  ...
  // Use the custom product units hook
  const {
    units,
    ...
    <Card className="mb-6">
      ...
      <CardContent>
        {offer.products.map((product, index) => (
          <div key={product.id} className="mb-6 relative rounded-lg border p-4 bg-gray-50">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => updateProduct(product.id, { showBundledPrices: !!checked })}
                    />
                    <Label
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={e => setNewBundleProduct({
                      ...newBundleProduct,
                      name: e.target.value
                    })}
                  />
